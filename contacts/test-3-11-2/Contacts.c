...
{
	return ((Contacts*)e1)->data->name - ((Contacts*)e2)->data->name;
}
...
{
	return ((Contacts*)e1)->data->sex - ((Contacts*)e2)->data->sex;
}
...
void ContactsSort(Contacts* pc)
{
	...
	do
	{
		...
		{
		case NAMESORT:
			ContactsBubblesort(pc, pc->size, sizeof(pc->data[0]), compareName);
			printf("sequence\n");
				Sleep(1000);
			break;
		case AGESORT:
			ContactsBubblesort(pc, pc->size, sizeof(pc->data[0]), compareAge);
			printf("sequence\n");
			Sleep(1000);
			break;
		case SEXSORT:
			ContactsBubblesort(pc, pc->size, sizeof(pc->data[0]), compareSex);
			printf("sequence\n");
			Sleep(1000);
			break;
		case RETURN:
